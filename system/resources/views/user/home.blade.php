    ...
    <div id="myCarousel" class="carousel slide banner-main" data-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img class="first-slide" src="{{url('public')}}/dist/user/images/banner.jpg" alt="First slide">
                <div class="container">
            ...
            <div class="carousel-item">
                <img class="second-slide" src="{{url('public')}}/dist/user/images/banner.jpg" alt="Second slide">
                <div class="container">
                    <div class="carousel-caption relative">
                        <span>Semua Merk HP </span>
                        <h1>Dapatkan Discount 25% Saat Promo</h1>
            ...
            <div class="container">
                ...
                @foreach($list_produk as $produk)
                  <div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 ">
                      <div class="brand_box">
                {{$loop->iteration}}
                      <img src="{{url('public')}}/dist/user/images/6.png" class="card-img-top" alt="...">
            ...
            <div class="modal-content">
                <div class="modal-header bg-dark">
                    ...
                    <div class="modal-body">
                        <div class="row">
                        <div class="col-md-6">
                            <img src="{{url('public')}}/dist/user/images/6.png">
                        </div>
                        <div class="col-md-6">
